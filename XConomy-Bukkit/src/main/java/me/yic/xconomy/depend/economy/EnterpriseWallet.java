...
public class EnterpriseWallet extends PlayerWallet {
    ...
    public EconomyAction setBalance(BigDecimal amount) {
        ...
        if (DataCon.changeplayerdata("PLUGIN", getPlayer().getUniqueId(), amount, null, null ,null)) {
    ...
    public EconomyAction withdraw(BigDecimal amount) {
        ...
        if (DataCon.changeplayerdata("PLUGIN", playeruuid, amount, false, null, null)) {
            return new EconomyAction(getHolder(), true, "");
        } else {
            return new EconomyAction(getHolder(), false,  "Money not enough!");
        }
    ...
    public EconomyAction deposit(BigDecimal amount) {
        ...
        UUID playerUUID = getPlayer().getUniqueId();
        if (DataCon.changeplayerdata("PLUGIN", playerUUID, amount, true, null, null)) {
            return new EconomyAction(getHolder(), true, "");
        } else {
            return new EconomyAction(getHolder(), false,  "Money not enough!");
        }
